...
export const TodoContextProvider =( {children} )=>{
    ...
    const addTodo =(newTodo)=>{
        ...
        axios.post(urlAPI, newTodoBelongCurrentUser)
        .then((res)=>{
    ...
    const editTodo =(id, title)=>{
        ...
        axios.patch(`${urlAPI}/${id}`, {title: title})
        .then((res) => {
    ...
    const handleTodoState =(id, currentState)=>{
        ...
        axios.patch(`${urlAPI}/${id}`, {completed: !currentState})
        .then((res) => {
    ...
    return <TodoContext.Provider  value={{todos, addTodo, deleteTodo, editTodo, handleTodoState, clearAllTodos}} >
        {children}
