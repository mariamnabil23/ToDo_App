      ...
      <div className="modal-box">
        ...
        <div className="modal-action block">
          <form method="dialog  flex flex-col items-center justify-between w-full bg-red-300">
            ...
            <input type='text' placeholder='Todo Title .... ' className='outline-0 w-50  border-2 border-indigo-600  px-2  rounded-md'  onChange={(e)}  />

            {/* if there is a button in form, it will close the modal */}
            <div  className='mt-10'>
              <button className="btn btn-error"    onClick={closeModal} >Cancel</button>
              <button className="btn btn-primary  ml-5"   onClick={()=>(addTodo("hi"))}>Add</button>
            </div>
